<template>
  <div>
    ...
    <footer class="footer">
      <div class="container">
        <div class="row">
          <div class="col-lg-6 footer_col mt-5">
          ...
          <div class="col-lg-2 mt-5">
            <div class="footer_column">
              ...
              <ul class="footer_list">
                ...
                <li>
                  <nuxt-link to="/blog/post">Blog</nuxt-link>
                </li>
                <li>
          ...
          <div class="col-lg-2 mt-5">
            <div class="footer_column">
              <div class="footer_title" style="color: #f1be03">Contact Us</div>
              <ul class="footer_list">
          ...
          <div class="col-lg-2 mt-5">
            <div class="footer_column">
              <div class="footer_title" style="color: #f1be03">Brands</div>
              <ul class="footer_list">
                <li style="font-size: 0.9rem;">
                  <p class="text-small">Beverly International.</p>
                  <p class="text-small">Blackstone Labs.</p>
